...
// Create a new type of Settings Asset.
  ...
  class NeodroidSettings : ScriptableObject {
    ...
    public String SomeString { get { return this._string; } set { this._string = value; } }

    public int Number { get { return this._number; } set { this._number = value; } }

    public bool SomeBool { get { return this._bool; } set { this._bool = value; } }
    ...
    public static SettingsProvider CreateMyCustomSettingsProvider() {
      var provider = new SettingsProvider(NeodroidEditorConstants.neodroid_project_settings_menu_path,
                                          SettingsScope.Project) {
                                                                     ...
                                                                     label =
                                                                         "Neodroid", // By default the last token of the path is used as display name if no label is provided.
