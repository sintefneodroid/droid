...
public struct FReaction : IFlatbufferObject
{
  ...
  public FUnobservables? Unobservables { get { int o = __p.__offset(12); return o != 0 ? (FUnobservables?)(new FUnobservables()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
