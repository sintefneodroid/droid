  ...
  public struct FState : IFlatbufferObject
{
  ...
  public FUnobservables? Unobservables { get { int o = __p.__offset(20); return o != 0 ? (FUnobservables?)(new FUnobservables()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
...
public struct FMotor : IFlatbufferObject
{
  ...
  public FRange? ValidInput { get { int o = __p.__offset(6); return o != 0 ? (FRange?)(new FRange()).__assign(o + __p.bb_pos, __p.bb) : null; } }
