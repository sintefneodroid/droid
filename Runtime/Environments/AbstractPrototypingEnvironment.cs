...
namespace droid.Runtime.Environments {
...

  {
    ...
    [SerializeField]
    protected ObjectiveFunction _objective_function;
    ...
    ///
    /// </summary>
    protected List<ActuatorMotion> _Sample_Motions = new List<ActuatorMotion>();
    ...
    /// <summary>
    /// </summary>
    public SortedDictionary<string, IEnvironmentListener> Listeners { get; } =
      new SortedDictionary<string, IEnvironmentListener>();
    ...
    /// </summary>
    /// <param name="reaction"></param>
    protected abstract void InnerStep(Reaction reaction);
