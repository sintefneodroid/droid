...
namespace droid.Runtime.Environments
{
  ...
  public class PrototypingEnvironment : NeodroidEnvironment, IPrototypingEnvironment{
    ...
    {
      this.Register(displayer, displayer.Identifier);
    }
    ...
    {
      this.Register(actor, actor.Identifier);
    }
    ...
    {
      this.Register(observer, observer.Identifier);
    }
    ...
    {
      this.UnRegister(actor, actor.Identifier);
    }
    ...
    {
      this.UnRegister(observer, observer.Identifier);
    }
    ...
    {
      this.UnRegister(displayer, displayer.Identifier);
    }
    ...
    {
      this.UnRegister(resetable, resetable.Identifier);
    }
