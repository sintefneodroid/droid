...
#pragma surface surf Standard fullforwardshadows vertex:vert
        ...
        void vert(inout appdata_full v, out Input o)
        {
            ...
            o.cameraRelativeWorldPos = mul(unity_ObjectToWorld, float4(v.vertex.xyz, 1.0)) -
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            half3 flatWorldNormal = normalize(cross(ddy(IN.cameraRelativeWorldPos.xyz),
                                                    ddx(IN.cameraRelativeWorldPos.xyz)));
