    ...
    public class Perlin
    {
        ...
        public void SetSeed(int seed)
        {
            ...
            for (i = 0; i < _b; i++)
            {
                ...
                for (j = 0; j < 2; j++) this._g2[i, j] = (float)(rnd.Next(_b + _b) - _b) / _b;
                Normalize2(ref this._g2[i, 0], ref this._g2[i, 1]);

                for (j = 0; j < 3; j++) this._g3[i, j] = (float)(rnd.Next(_b + _b) - _b) / _b;
            ...
            for (i = 0; i < _b + 2; i++)
            {
                ...
                for (j = 0; j < 2; j++) this._g2[_b + i, j] = this._g2[i, j];
                for (j = 0; j < 3; j++) this._g3[_b + i, j] = this._g3[i, j];
            }
        }
    }
}
