...
namespace droid.Tests.Editor.Structs.Space {
  ...
  public class Space4Tests {
    ...
    public void TestDenormalise010() {
      var space = new Space4 {Min = Vector4.zero, Max = Vector4.one * 10, Normalised = NormalisationEnum.Zero_one_};
    ...
    public void TestNormaliseMinus11() {
      var space = new Space4 {Min = Vector4.one * -1, Max = Vector4.one * 1, Normalised = NormalisationEnum.Zero_one_};
